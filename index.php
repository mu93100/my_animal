...
<html lang="en">
    ...
    Sans action -->
        ...
        <form method="post" action="index.php">
            ...
            <button class="submitInterBtn" type="submit" name="action" value="create">Enregistre ton animal favori</button>
        </form>
        ...
        <?php if ($nouvelAnimal) : ?>
            ...
            <form id="formUpdateFull" class="hide" method="post" action="index.php">
                ...
                <input class="p1" type="text" name="age" value="<?= $nouvelAnimal->getAge() ?> an(s)">
                <input class="p1" type="text" name="poids" value="<?= $nouvelAnimal->getPoids() ?> kg">
                <button class="submitInterBtn" type="submit" name="action" value="update">Mettre à jour</button>
            </form>
        <?php endif; ?>
